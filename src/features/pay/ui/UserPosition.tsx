        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 border border-gray-400 border-t-0 rounded-b-md">
            {workHeaders.map((h) => (
              <div
                key={h.key}
                className="p-2 border-r last:border-r-0 border-b border-gray-200 text-center"
              >
                <div className="text-sm text-gray-700">{h.label}</div>
                <div className="mt-1 font-semibold text-sm">{user.work[h.key]}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap justify-center border border-gray-400 border-t-0 rounded-b-md">
            {payHeaders.map((h) => (
              <div
                key={h.key}
                className="w-1/2 md:w-1/3 p-2 border-r last:border-r-0 border-b border-gray-200 text-center"
              >
                <div className="text-sm text-gray-700">{h.label}</div>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap justify-center border border-gray-400 border-t-0 rounded-b-md">
            {insuranceHeaders.map((h) => (
              <div
                key={h.key}
                className="w-1/2 md:w-1/4 p-2 border-r last:border-r-0 border-b border-gray-200 text-center"
              >
                <div className="text-sm text-gray-700">{h.label}</div>
